...
/**
 * MOCK Transactional API for Order Payments.
 * 
 * In a real backend, these methods would correspond to endpoints like:
 * POST /api/orders/:id/payments
 * PUT /api/orders/:id/payments/:paymentId
 * DELETE /api/orders/:id/payments/:paymentId
 * 
 * Ideally, the backend handles the transaction. Here we simulate it by orchestrating
 * calls to other mocks internally.
 */
