...
export function ExchangesReceptionHistoryPage() {
    ...
    const { data: response, isLoading } = useQuery({
        queryKey: ['exchanges-receipt-history', page, searchTerm, receiptFilter, manualFilter, brandFilter, statusFilter, dateRange],
        queryFn: async () => {
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8 gap-4 items-end">
                                ...
                                <DateRangePicker 
                                    ...
                                    showLabel={true}
                                    className="flex flex-col gap-1.5 col-span-1 md:col-span-2"
                                    buttonClassName="h-9 text-xs"
                                />
