...
import { useReceptionBatch } from "@/features/reception-batch/model/useReceptionBatch"
import { PendingOrdersTable } from "@/features/reception-batch/ui/PendingOrdersTable"
...
export function ExchangesReceptionPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader
                title={editingBatchId ? 'Editando Lote de Cambios' : 'Recepción de Cambios (Bodega)'}
                description={editingBatchId ? 'Modificando un lote de cambios ya registrado' : 'Gestión y control de entrada de cambios'}
                icon={Truck}
                actions={
