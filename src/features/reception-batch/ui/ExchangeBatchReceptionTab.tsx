...
import { useExchangeBatches, useUpdateExchangeBatchStatus } from '@/features/exchanges/model/useExchanges';
import type { ExchangeBatch, ExchangeBatchItem } from '@/features/exchanges/model/types';

interface Props {
  onReceiveBatch: (batch: ExchangeBatch) => void;
}

export function ExchangeBatchReceptionTab({ onReceiveBatch }: Props) {
